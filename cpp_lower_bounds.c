 ...
 *         vector[int] N = N_
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_h_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 53, __pyx_L1_error)
  __pyx_v_h = __pyx_t_1;

  /* "cpp_lower_bounds.pyx":54
 *     cdef:
 *         int h = h_
 *         int truck_capacity = truck_capacity_             # <<<<<<<<<<<<<<
 *         vector[int] N = N_
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_truck_capacity_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L1_error)
  __pyx_v_truck_capacity = __pyx_t_1;

  /* "cpp_lower_bounds.pyx":55
 *         int h = h_
 *         int truck_capacity = truck_capacity_
 *         vector[int] N = N_             # <<<<<<<<<<<<<<
 *         vector[vector[double]] distance = distance_
 ...
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_N_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L1_error)
  __pyx_v_N = __pyx_t_2;

  /* "cpp_lower_bounds.pyx":56
 *         int truck_capacity = truck_capacity_
 *         vector[int] N = N_
 *         vector[vector[double]] distance = distance_             # <<<<<<<<<<<<<<
 *         vector[int] values = values_
 ...
 */
  __pyx_t_3 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_double_3e___(__pyx_v_distance_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L1_error)
  __pyx_v_distance = __pyx_t_3;

  /* "cpp_lower_bounds.pyx":57
 *         vector[int] N = N_
 *         vector[vector[double]] distance = distance_
 *         vector[int] values = values_             # <<<<<<<<<<<<<<
 *         map[int,int] values_pos = values_pos_
 ...
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_values_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 57, __pyx_L1_error)
  __pyx_v_values = __pyx_t_2;

  /* "cpp_lower_bounds.pyx":58
 *         vector[vector[double]] distance = distance_
 *         vector[int] values = values_
 *         map[int,int] values_pos = values_pos_             # <<<<<<<<<<<<<<
 *         vector[int] quantities = quantities_
 ...
 */
  __pyx_t_4 = __pyx_convert_map_from_py_int__and_int(__pyx_v_values_pos_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 58, __pyx_L1_error)
  __pyx_v_values_pos = __pyx_t_4;

  /* "cpp_lower_bounds.pyx":59
 *         vector[int] values = values_
 *         map[int,int] values_pos = values_pos_
 *         vector[int] quantities = quantities_             # <<<<<<<<<<<<<<
 *         string direction = direction_
 * 
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_quantities_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 59, __pyx_L1_error)
  __pyx_v_quantities = __pyx_t_2;

  /* "cpp_lower_bounds.pyx":60
 *         map[int,int] values_pos = values_pos_
 *         vector[int] quantities = quantities_
 *         string direction = direction_             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_5 = __pyx_convert_string_from_py_std__in_string(__pyx_v_direction_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 60, __pyx_L1_error)
  __pyx_v_direction = __pyx_t_5;

  /* "cpp_lower_bounds.pyx":62
 *         string direction = direction_
 * 
 *     cdef QPaths qpaths = construct_q_paths_(h,truck_capacity,N,distance,values,values_pos,quantities,direction)             # <<<<<<<<<<<<<<
 *     return qpaths
 ...
 */
  ...
  __pyx_t_6 = __pyx_convert__to_py_struct__QPaths(__pyx_v_qpaths); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 63, __pyx_L1_error)
...
static PyObject *__pyx_pw_16cpp_lower_bounds_1construct_q_paths(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_truck_capacity)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 1); __PYX_ERR(0, 51, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_N)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 2); __PYX_ERR(0, 51, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_distance)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 3); __PYX_ERR(0, 51, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_values)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 4); __PYX_ERR(0, 51, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_values_pos)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 5); __PYX_ERR(0, 51, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_quantities)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 6); __PYX_ERR(0, 51, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_direction)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 7); __PYX_ERR(0, 51, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "construct_q_paths") < 0)) __PYX_ERR(0, 51, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 51, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cpp_lower_bounds.construct_q_paths", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_16cpp_lower_bounds_construct_q_paths(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_h_, PyObject *__pyx_v_truck_capacity_, PyObject *__pyx_v_N_, PyObject *__pyx_v_distance_, PyObject *__pyx_v_values_, PyObject *__pyx_v_values_pos_, PyObject *__pyx_v_quantities_, PyObject *__pyx_v_direction_) {
  ...
  __Pyx_RefNannySetupContext("construct_q_paths", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_16cpp_lower_bounds_construct_q_paths(__pyx_v_h_, __pyx_v_truck_capacity_, __pyx_v_N_, __pyx_v_distance_, __pyx_v_values_, __pyx_v_values_pos_, __pyx_v_quantities_, __pyx_v_direction_, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
 ...
 *       vector[int] N = N_
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_h_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 67, __pyx_L1_error)
  __pyx_v_h = __pyx_t_1;

  /* "cpp_lower_bounds.pyx":68
 *    cdef:
 *       int h = h_
 *       int truck_capacity = truck_capacity_             # <<<<<<<<<<<<<<
 *       vector[int] N = N_
 *       vector[vector[double]] distance = distance_
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_truck_capacity_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 68, __pyx_L1_error)
  __pyx_v_truck_capacity = __pyx_t_1;

  /* "cpp_lower_bounds.pyx":69
 *       int h = h_
 *       int truck_capacity = truck_capacity_
 *       vector[int] N = N_             # <<<<<<<<<<<<<<
 *       vector[vector[double]] distance = distance_
 *       vector[int] values = values_
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_N_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 69, __pyx_L1_error)
  __pyx_v_N = __pyx_t_2;

  /* "cpp_lower_bounds.pyx":70
 *       int truck_capacity = truck_capacity_
 *       vector[int] N = N_
 *       vector[vector[double]] distance = distance_             # <<<<<<<<<<<<<<
 *       vector[int] values = values_
 *       map[int,int] values_pos = values_pos_
 */
  __pyx_t_3 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_double_3e___(__pyx_v_distance_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 70, __pyx_L1_error)
  __pyx_v_distance = __pyx_t_3;

  /* "cpp_lower_bounds.pyx":71
 *       vector[int] N = N_
 *       vector[vector[double]] distance = distance_
 *       vector[int] values = values_             # <<<<<<<<<<<<<<
 *       map[int,int] values_pos = values_pos_
 *       vector[int] quantities = quantities_
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_values_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 71, __pyx_L1_error)
  __pyx_v_values = __pyx_t_2;

  /* "cpp_lower_bounds.pyx":72
 *       vector[vector[double]] distance = distance_
 *       vector[int] values = values_
 *       map[int,int] values_pos = values_pos_             # <<<<<<<<<<<<<<
 *       vector[int] quantities = quantities_
 * 
 */
  __pyx_t_4 = __pyx_convert_map_from_py_int__and_int(__pyx_v_values_pos_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 72, __pyx_L1_error)
  __pyx_v_values_pos = __pyx_t_4;

  /* "cpp_lower_bounds.pyx":73
 *       vector[int] values = values_
 *       map[int,int] values_pos = values_pos_
 *       vector[int] quantities = quantities_             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_quantities_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 73, __pyx_L1_error)
  __pyx_v_quantities = __pyx_t_2;

  /* "cpp_lower_bounds.pyx":75
 *       vector[int] quantities = quantities_
 * 
 *    cdef QRoutes qroutes = construct_q_routes_(h,truck_capacity,N,distance,values,values_pos,quantities)             # <<<<<<<<<<<<<<
 *    return qroutes
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_5 = __pyx_convert__to_py_struct__QRoutes(__pyx_v_qroutes); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 76, __pyx_L1_error)
...
static PyObject *__pyx_pw_16cpp_lower_bounds_3construct_q_routes(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_truck_capacity)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, 1); __PYX_ERR(0, 65, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_N)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, 2); __PYX_ERR(0, 65, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_distance)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, 3); __PYX_ERR(0, 65, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_values)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, 4); __PYX_ERR(0, 65, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_values_pos)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, 5); __PYX_ERR(0, 65, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_quantities)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, 6); __PYX_ERR(0, 65, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "construct_q_routes") < 0)) __PYX_ERR(0, 65, __pyx_L3_error)
      }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 65, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cpp_lower_bounds.construct_q_routes", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_16cpp_lower_bounds_2construct_q_routes(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_h_, PyObject *__pyx_v_truck_capacity_, PyObject *__pyx_v_N_, PyObject *__pyx_v_distance_, PyObject *__pyx_v_values_, PyObject *__pyx_v_values_pos_, PyObject *__pyx_v_quantities_) {
  ...
  __Pyx_RefNannySetupContext("construct_q_routes", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_16cpp_lower_bounds_construct_q_routes(__pyx_v_h_, __pyx_v_truck_capacity_, __pyx_v_N_, __pyx_v_distance_, __pyx_v_values_, __pyx_v_values_pos_, __pyx_v_quantities_, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 *       vector[int] N = N_,
 */
  __pyx_t_1 = __pyx_convert_vector_from_py_int(__pyx_v_H_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 80, __pyx_L1_error)
  __pyx_v_H = __pyx_t_1;

  /* "cpp_lower_bounds.pyx":81
 *    cdef:
 *       vector[int] H = H_,
 *       vector[int] capacities = capacities_,             # <<<<<<<<<<<<<<
 *       vector[int] N = N_,
 *       vector[int] quantities = quantities_,
 */
  __pyx_t_1 = __pyx_convert_vector_from_py_int(__pyx_v_capacities_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 81, __pyx_L1_error)
  __pyx_v_capacities = __pyx_t_1;

  /* "cpp_lower_bounds.pyx":82
 *       vector[int] H = H_,
 *       vector[int] capacities = capacities_,
 *       vector[int] N = N_,             # <<<<<<<<<<<<<<
 *       vector[int] quantities = quantities_,
 *       vector[vector[double]] distance = distance_,
 */
  __pyx_t_1 = __pyx_convert_vector_from_py_int(__pyx_v_N_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 82, __pyx_L1_error)
  __pyx_v_N = __pyx_t_1;

  /* "cpp_lower_bounds.pyx":83
 *       vector[int] capacities = capacities_,
 *       vector[int] N = N_,
 *       vector[int] quantities = quantities_,             # <<<<<<<<<<<<<<
 *       vector[vector[double]] distance = distance_,
 ...
 */
  __pyx_t_1 = __pyx_convert_vector_from_py_int(__pyx_v_quantities_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 83, __pyx_L1_error)
  __pyx_v_quantities = __pyx_t_1;

  /* "cpp_lower_bounds.pyx":84
 *       vector[int] N = N_,
 *       vector[int] quantities = quantities_,
 *       vector[vector[double]] distance = distance_,             # <<<<<<<<<<<<<<
 *       vector[double] mu = mu_,
 ...
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_double_3e___(__pyx_v_distance_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 84, __pyx_L1_error)
  __pyx_v_distance = __pyx_t_2;

  /* "cpp_lower_bounds.pyx":85
 *       vector[int] quantities = quantities_,
 *       vector[vector[double]] distance = distance_,
 *       vector[double] mu = mu_,             # <<<<<<<<<<<<<<
 *       vector[double] lamb = lamb_
 * 
 */
  __pyx_t_3 = __pyx_convert_vector_from_py_double(__pyx_v_mu_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 85, __pyx_L1_error)
  __pyx_v_mu = __pyx_t_3;

  /* "cpp_lower_bounds.pyx":86
 *       vector[vector[double]] distance = distance_,
 *       vector[double] mu = mu_,
 *       vector[double] lamb = lamb_             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_3 = __pyx_convert_vector_from_py_double(__pyx_v_lamb_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 86, __pyx_L1_error)
  __pyx_v_lamb = __pyx_t_3;

  /* "cpp_lower_bounds.pyx":88
 *       vector[double] lamb = lamb_
 * 
 *    cdef LowerBound lb = lower_bound_(H, capacities, N, quantities, distance, mu, lamb)             # <<<<<<<<<<<<<<
 *    return lb
 */
  ...
  /* "cpp_lower_bounds.pyx":89
 * 
 *    cdef LowerBound lb = lower_bound_(H, capacities, N, quantities, distance, mu, lamb)
 *    return lb             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_4 = __pyx_convert__to_py_struct__LowerBound(__pyx_v_lb); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 89, __pyx_L1_error)
...
static PyObject *__pyx_pw_16cpp_lower_bounds_5lower_bound(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_capacities)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("lower_bound", 1, 7, 7, 1); __PYX_ERR(0, 78, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_N)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lower_bound", 1, 7, 7, 2); __PYX_ERR(0, 78, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_quantities)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lower_bound", 1, 7, 7, 3); __PYX_ERR(0, 78, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_distance)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lower_bound", 1, 7, 7, 4); __PYX_ERR(0, 78, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mu)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lower_bound", 1, 7, 7, 5); __PYX_ERR(0, 78, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_lamb)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lower_bound", 1, 7, 7, 6); __PYX_ERR(0, 78, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "lower_bound") < 0)) __PYX_ERR(0, 78, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 7) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("lower_bound", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 78, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cpp_lower_bounds.lower_bound", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_16cpp_lower_bounds_4lower_bound(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_H_, PyObject *__pyx_v_capacities_, PyObject *__pyx_v_N_, PyObject *__pyx_v_quantities_, PyObject *__pyx_v_distance_, PyObject *__pyx_v_mu_, PyObject *__pyx_v_lamb_) {
  ...
  __Pyx_RefNannySetupContext("lower_bound", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_16cpp_lower_bounds_lower_bound(__pyx_v_H_, __pyx_v_capacities_, __pyx_v_N_, __pyx_v_quantities_, __pyx_v_distance_, __pyx_v_mu_, __pyx_v_lamb_, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;
    __pyx_t_4 = __pyx_convert_vector_to_py_std_3a__3a_vector_3c_int_3e___((__pyx_v_v[__pyx_v_i])); if (unlikely(!__pyx_t_4)) __PYX_ERR(2, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    if (unlikely(__Pyx_ListComp_Append(__pyx_t_1, (PyObject*)__pyx_t_4))) __PYX_ERR(2, 68, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  }
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cpp_lower_bounds", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
