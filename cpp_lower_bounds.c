...
static PyObject* __pyx_convert__to_py_struct__Path(struct Path s);
...
static PyObject *__pyx_f_16cpp_lower_bounds_GENPATH_(PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_16cpp_lower_bounds_GENROUTE_(PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_convert_list_to_py_struct__Path(std::list<struct Path>  const &); /*proto*/
static PyObject *__pyx_convert_vector_to_py_std_3a__3a_list_3c_struct__Path_3e___(const std::vector<std::list<struct Path> >  &); /*proto*/
...
static const char __pyx_k_capacity[] = "capacity_";
...
static const char __pyx_k_distance_dict[] = "distance_dict_";
...
static PyObject *__pyx_pf_16cpp_lower_bounds_4GENPATH_(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_Delta_, PyObject *__pyx_v_gamma_, PyObject *__pyx_v_h_, PyObject *__pyx_v_capacity_, PyObject *__pyx_v_N_, PyObject *__pyx_v_quantities_, PyObject *__pyx_v_distance_dict_, PyObject *__pyx_v_direction_); /* proto */
static PyObject *__pyx_pf_16cpp_lower_bounds_6GENROUTE_(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_Delta_, PyObject *__pyx_v_gamma_, PyObject *__pyx_v_h_, PyObject *__pyx_v_capacity_, PyObject *__pyx_v_N_, PyObject *__pyx_v_quantities_, PyObject *__pyx_v_distance_dict_); /* proto */
 ...
 *         vector[int] N = N_
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_h_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 96, __pyx_L1_error)
  __pyx_v_h = __pyx_t_1;

  /* "cpp_lower_bounds.pyx":97
 *     cdef:
 *         int h = h_
 *         int truck_capacity = truck_capacity_             # <<<<<<<<<<<<<<
 *         vector[int] N = N_
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_truck_capacity_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 97, __pyx_L1_error)
  __pyx_v_truck_capacity = __pyx_t_1;

  /* "cpp_lower_bounds.pyx":98
 *         int h = h_
 *         int truck_capacity = truck_capacity_
 *         vector[int] N = N_             # <<<<<<<<<<<<<<
 *         vector[vector[double]] distance = distance_
 ...
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_N_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 98, __pyx_L1_error)
  __pyx_v_N = __pyx_t_2;

  /* "cpp_lower_bounds.pyx":99
 *         int truck_capacity = truck_capacity_
 *         vector[int] N = N_
 *         vector[vector[double]] distance = distance_             # <<<<<<<<<<<<<<
 *         vector[int] values = values_
 ...
 */
  __pyx_t_3 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_double_3e___(__pyx_v_distance_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 99, __pyx_L1_error)
  __pyx_v_distance = __pyx_t_3;

  /* "cpp_lower_bounds.pyx":100
 *         vector[int] N = N_
 *         vector[vector[double]] distance = distance_
 *         vector[int] values = values_             # <<<<<<<<<<<<<<
 *         map[int,int] values_pos = values_pos_
 ...
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_values_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 100, __pyx_L1_error)
  __pyx_v_values = __pyx_t_2;

  /* "cpp_lower_bounds.pyx":101
 *         vector[vector[double]] distance = distance_
 *         vector[int] values = values_
 *         map[int,int] values_pos = values_pos_             # <<<<<<<<<<<<<<
 *         vector[int] quantities = quantities_
 ...
 */
  __pyx_t_4 = __pyx_convert_map_from_py_int__and_int(__pyx_v_values_pos_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 101, __pyx_L1_error)
  __pyx_v_values_pos = __pyx_t_4;

  /* "cpp_lower_bounds.pyx":102
 *         vector[int] values = values_
 *         map[int,int] values_pos = values_pos_
 *         vector[int] quantities = quantities_             # <<<<<<<<<<<<<<
 *         string direction = direction_
 * 
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_quantities_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 102, __pyx_L1_error)
  __pyx_v_quantities = __pyx_t_2;

  /* "cpp_lower_bounds.pyx":103
 *         map[int,int] values_pos = values_pos_
 *         vector[int] quantities = quantities_
 *         string direction = direction_             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_5 = __pyx_convert_string_from_py_std__in_string(__pyx_v_direction_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 103, __pyx_L1_error)
  __pyx_v_direction = __pyx_t_5;

  /* "cpp_lower_bounds.pyx":105
 *         string direction = direction_
 * 
 *     cdef QPaths qpaths = construct_q_paths_(h,truck_capacity,N,distance,values,values_pos,quantities,direction)             # <<<<<<<<<<<<<<
 *     return qpaths
 ...
 */
  ...
  __pyx_t_6 = __pyx_convert__to_py_struct__QPaths(__pyx_v_qpaths); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 106, __pyx_L1_error)
...
static PyObject *__pyx_pw_16cpp_lower_bounds_1construct_q_paths(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_truck_capacity)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 1); __PYX_ERR(0, 94, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_N)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 2); __PYX_ERR(0, 94, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_distance)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 3); __PYX_ERR(0, 94, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_values)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 4); __PYX_ERR(0, 94, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_values_pos)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 5); __PYX_ERR(0, 94, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_quantities)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 6); __PYX_ERR(0, 94, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_direction)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, 7); __PYX_ERR(0, 94, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "construct_q_paths") < 0)) __PYX_ERR(0, 94, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("construct_q_paths", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 94, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cpp_lower_bounds.construct_q_paths", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_16cpp_lower_bounds_construct_q_paths(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_h_, PyObject *__pyx_v_truck_capacity_, PyObject *__pyx_v_N_, PyObject *__pyx_v_distance_, PyObject *__pyx_v_values_, PyObject *__pyx_v_values_pos_, PyObject *__pyx_v_quantities_, PyObject *__pyx_v_direction_) {
  ...
  __Pyx_RefNannySetupContext("construct_q_paths", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_16cpp_lower_bounds_construct_q_paths(__pyx_v_h_, __pyx_v_truck_capacity_, __pyx_v_N_, __pyx_v_distance_, __pyx_v_values_, __pyx_v_values_pos_, __pyx_v_quantities_, __pyx_v_direction_, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 94, __pyx_L1_error)
 ...
 *       vector[int] N = N_
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_h_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 110, __pyx_L1_error)
  __pyx_v_h = __pyx_t_1;

  /* "cpp_lower_bounds.pyx":111
 *    cdef:
 *       int h = h_
 *       int truck_capacity = truck_capacity_             # <<<<<<<<<<<<<<
 *       vector[int] N = N_
 *       vector[vector[double]] distance = distance_
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_truck_capacity_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 111, __pyx_L1_error)
  __pyx_v_truck_capacity = __pyx_t_1;

  /* "cpp_lower_bounds.pyx":112
 *       int h = h_
 *       int truck_capacity = truck_capacity_
 *       vector[int] N = N_             # <<<<<<<<<<<<<<
 *       vector[vector[double]] distance = distance_
 *       vector[int] values = values_
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_N_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 112, __pyx_L1_error)
  __pyx_v_N = __pyx_t_2;

  /* "cpp_lower_bounds.pyx":113
 *       int truck_capacity = truck_capacity_
 *       vector[int] N = N_
 *       vector[vector[double]] distance = distance_             # <<<<<<<<<<<<<<
 *       vector[int] values = values_
 *       map[int,int] values_pos = values_pos_
 */
  __pyx_t_3 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_double_3e___(__pyx_v_distance_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 113, __pyx_L1_error)
  __pyx_v_distance = __pyx_t_3;

  /* "cpp_lower_bounds.pyx":114
 *       vector[int] N = N_
 *       vector[vector[double]] distance = distance_
 *       vector[int] values = values_             # <<<<<<<<<<<<<<
 *       map[int,int] values_pos = values_pos_
 *       vector[int] quantities = quantities_
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_values_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 114, __pyx_L1_error)
  __pyx_v_values = __pyx_t_2;
 ...
 * 
 */
  __pyx_t_4 = __pyx_convert_map_from_py_int__and_int(__pyx_v_values_pos_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 115, __pyx_L1_error)
  __pyx_v_values_pos = __pyx_t_4;

  /* "cpp_lower_bounds.pyx":116
 *       vector[int] values = values_
 *       map[int,int] values_pos = values_pos_
 *       vector[int] quantities = quantities_             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = __pyx_convert_vector_from_py_int(__pyx_v_quantities_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 116, __pyx_L1_error)
  __pyx_v_quantities = __pyx_t_2;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_5 = __pyx_convert__to_py_struct__QRoutes(__pyx_v_qroutes); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 119, __pyx_L1_error)
...
static PyObject *__pyx_pw_16cpp_lower_bounds_3construct_q_routes(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_truck_capacity)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, 1); __PYX_ERR(0, 108, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_N)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, 2); __PYX_ERR(0, 108, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_distance)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, 3); __PYX_ERR(0, 108, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_values)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, 4); __PYX_ERR(0, 108, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_values_pos)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, 5); __PYX_ERR(0, 108, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_quantities)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, 6); __PYX_ERR(0, 108, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "construct_q_routes") < 0)) __PYX_ERR(0, 108, __pyx_L3_error)
      }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("construct_q_routes", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 108, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cpp_lower_bounds.construct_q_routes", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_16cpp_lower_bounds_2construct_q_routes(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_h_, PyObject *__pyx_v_truck_capacity_, PyObject *__pyx_v_N_, PyObject *__pyx_v_distance_, PyObject *__pyx_v_values_, PyObject *__pyx_v_values_pos_, PyObject *__pyx_v_quantities_) {
  ...
  __Pyx_RefNannySetupContext("construct_q_routes", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_16cpp_lower_bounds_construct_q_routes(__pyx_v_h_, __pyx_v_truck_capacity_, __pyx_v_N_, __pyx_v_distance_, __pyx_v_values_, __pyx_v_values_pos_, __pyx_v_quantities_, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 108, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_16cpp_lower_bounds_5GENPATH_(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_16cpp_lower_bounds_GENPATH_(PyObject *__pyx_v_Delta_, PyObject *__pyx_v_gamma_, PyObject *__pyx_v_h_, PyObject *__pyx_v_capacity_, PyObject *__pyx_v_N_, PyObject *__pyx_v_quantities_, PyObject *__pyx_v_distance_dict_, PyObject *__pyx_v_direction_, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_Delta;
  ...
  std::vector<int>  __pyx_v_N;
  std::vector<int>  __pyx_v_quantities;
  std::vector<std::vector<double> >  __pyx_v_distance_dict;
  std::string __pyx_v_direction;
  std::vector<std::list<struct Path> >  __pyx_v_paths;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  double __pyx_t_2;
  ...
  std::string __pyx_t_5;
  PyObject *__pyx_t_6 = NULL;
  __Pyx_RefNannySetupContext("GENPATH_", 0);
 ...
 *       int h = h_
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_Delta_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 123, __pyx_L1_error)
 ...
 */
  __pyx_t_2 = __pyx_PyFloat_AsDouble(__pyx_v_gamma_); if (unlikely((__pyx_t_2 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 124, __pyx_L1_error)
 ...
 *       vector[int] N = N_
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_h_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 125, __pyx_L1_error)
  __pyx_v_h = __pyx_t_1;
 ...
 *       vector[int] quantities = quantities_
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_capacity_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 126, __pyx_L1_error)
 ...
 */
  __pyx_t_3 = __pyx_convert_vector_from_py_int(__pyx_v_N_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 127, __pyx_L1_error)
  __pyx_v_N = __pyx_t_3;

  /* "cpp_lower_bounds.pyx":128
 *       int capacity = capacity_
 *       vector[int] N = N_
 *       vector[int] quantities = quantities_             # <<<<<<<<<<<<<<
 *       vector[vector[double]] distance_dict = distance_dict_
 *       string direction = direction_
 */
  __pyx_t_3 = __pyx_convert_vector_from_py_int(__pyx_v_quantities_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 128, __pyx_L1_error)
 ...
 */
  __pyx_t_4 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_double_3e___(__pyx_v_distance_dict_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 129, __pyx_L1_error)
  __pyx_v_distance_dict = __pyx_t_4;
 ...
 *    return paths
 */
  __pyx_t_5 = __pyx_convert_string_from_py_std__in_string(__pyx_v_direction_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 130, __pyx_L1_error)
  __pyx_v_direction = __pyx_t_5;
 ...
 * 
 */
  __pyx_v_paths = GENPATH(__pyx_v_Delta, __pyx_v_gamma, __pyx_v_h, __pyx_v_capacity, __pyx_v_N, __pyx_v_quantities, __pyx_v_distance_dict, __pyx_v_direction);
 ...
 *    return paths             # <<<<<<<<<<<<<<
 * 
 * cpdef GENROUTE_(Delta_, gamma_, h_, capacity_, N_, quantities_, distance_dict_):
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_6 = __pyx_convert_vector_to_py_std_3a__3a_list_3c_struct__Path_3e___(__pyx_v_paths); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 132, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_r = __pyx_t_6;
  __pyx_t_6 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_6);
  __Pyx_AddTraceback("cpp_lower_bounds.GENPATH_", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_16cpp_lower_bounds_5GENPATH_(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_16cpp_lower_bounds_5GENPATH_(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_Delta_ = 0;
  PyObject *__pyx_v_gamma_ = 0;
  PyObject *__pyx_v_h_ = 0;
  PyObject *__pyx_v_capacity_ = 0;
  PyObject *__pyx_v_N_ = 0;
  PyObject *__pyx_v_quantities_ = 0;
  PyObject *__pyx_v_distance_dict_ = 0;
  PyObject *__pyx_v_direction_ = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("GENPATH_ (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_Delta,&__pyx_n_s_gamma,&__pyx_n_s_h,&__pyx_n_s_capacity,&__pyx_n_s_N,&__pyx_n_s_quantities,&__pyx_n_s_distance_dict,&__pyx_n_s_direction,0};
    PyObject* values[8] = {0,0,0,0,0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_gamma)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("GENPATH_", 1, 8, 8, 1); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_h)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("GENPATH_", 1, 8, 8, 2); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_capacity)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("GENPATH_", 1, 8, 8, 3); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_N)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("GENPATH_", 1, 8, 8, 4); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_quantities)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("GENPATH_", 1, 8, 8, 5); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_distance_dict)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("GENPATH_", 1, 8, 8, 6); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_direction)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("GENPATH_", 1, 8, 8, 7); __PYX_ERR(0, 121, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "GENPATH_") < 0)) __PYX_ERR(0, 121, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 8) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_Delta_ = values[0];
    __pyx_v_gamma_ = values[1];
    __pyx_v_h_ = values[2];
    __pyx_v_capacity_ = values[3];
    __pyx_v_N_ = values[4];
    __pyx_v_quantities_ = values[5];
    __pyx_v_distance_dict_ = values[6];
    __pyx_v_direction_ = values[7];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("GENPATH_", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 121, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cpp_lower_bounds.GENPATH_", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_16cpp_lower_bounds_4GENPATH_(__pyx_self, __pyx_v_Delta_, __pyx_v_gamma_, __pyx_v_h_, __pyx_v_capacity_, __pyx_v_N_, __pyx_v_quantities_, __pyx_v_distance_dict_, __pyx_v_direction_);
...
static PyObject *__pyx_pf_16cpp_lower_bounds_4GENPATH_(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_Delta_, PyObject *__pyx_v_gamma_, PyObject *__pyx_v_h_, PyObject *__pyx_v_capacity_, PyObject *__pyx_v_N_, PyObject *__pyx_v_quantities_, PyObject *__pyx_v_distance_dict_, PyObject *__pyx_v_direction_) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("GENPATH_", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_16cpp_lower_bounds_GENPATH_(__pyx_v_Delta_, __pyx_v_gamma_, __pyx_v_h_, __pyx_v_capacity_, __pyx_v_N_, __pyx_v_quantities_, __pyx_v_distance_dict_, __pyx_v_direction_, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 121, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_16cpp_lower_bounds_7GENROUTE_(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_16cpp_lower_bounds_GENROUTE_(PyObject *__pyx_v_Delta_, PyObject *__pyx_v_gamma_, PyObject *__pyx_v_h_, PyObject *__pyx_v_capacity_, PyObject *__pyx_v_N_, PyObject *__pyx_v_quantities_, PyObject *__pyx_v_distance_dict_, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_Delta;
  double __pyx_v_gamma;
  int __pyx_v_h;
  int __pyx_v_capacity;
  ...
  std::vector<int>  __pyx_v_quantities;
  std::vector<std::vector<double> >  __pyx_v_distance_dict;
  std::vector<std::list<struct SimpleRoute> >  __pyx_v_routes;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  double __pyx_t_2;
  ...
  std::vector<std::vector<double> >  __pyx_t_4;
  PyObject *__pyx_t_5 = NULL;
  __Pyx_RefNannySetupContext("GENROUTE_", 0);
 ...
 *       int h = h_
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_Delta_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 136, __pyx_L1_error)
  __pyx_v_Delta = __pyx_t_1;
 ...
 *       int capacity = capacity_
 */
  __pyx_t_2 = __pyx_PyFloat_AsDouble(__pyx_v_gamma_); if (unlikely((__pyx_t_2 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 137, __pyx_L1_error)
  __pyx_v_gamma = __pyx_t_2;
 ...
 *       vector[int] N = N_
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_h_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 138, __pyx_L1_error)
  __pyx_v_h = __pyx_t_1;
 ...
 *       vector[int] quantities = quantities_
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_capacity_); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 139, __pyx_L1_error)
  __pyx_v_capacity = __pyx_t_1;
 ...
 *       vector[vector[double]] distance_dict = distance_dict_
 */
  __pyx_t_3 = __pyx_convert_vector_from_py_int(__pyx_v_N_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 140, __pyx_L1_error)
  __pyx_v_N = __pyx_t_3;
 ...
 *       vector[int] quantities = quantities_             # <<<<<<<<<<<<<<
 *       vector[vector[double]] distance_dict = distance_dict_
 *    cdef vector[list[SimpleRoute]] routes = GENROUTE(Delta, gamma, h, capacity, N, quantities, distance_dict)
 */
  __pyx_t_3 = __pyx_convert_vector_from_py_int(__pyx_v_quantities_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 141, __pyx_L1_error)
  __pyx_v_quantities = __pyx_t_3;
 ...
 *    return routes
 */
  __pyx_t_4 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_double_3e___(__pyx_v_distance_dict_); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 142, __pyx_L1_error)
  __pyx_v_distance_dict = __pyx_t_4;
 ...
 *    return routes
 */
  __pyx_v_routes = GENROUTE(__pyx_v_Delta, __pyx_v_gamma, __pyx_v_h, __pyx_v_capacity, __pyx_v_N, __pyx_v_quantities, __pyx_v_distance_dict);
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_5 = __pyx_convert_vector_to_py_std_3a__3a_list_3c_struct__SimpleRoute_3e___(__pyx_v_routes); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 144, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_r = __pyx_t_5;
  __pyx_t_5 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_5);
  __Pyx_AddTraceback("cpp_lower_bounds.GENROUTE_", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_16cpp_lower_bounds_7GENROUTE_(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_16cpp_lower_bounds_7GENROUTE_(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_Delta_ = 0;
  PyObject *__pyx_v_gamma_ = 0;
  PyObject *__pyx_v_h_ = 0;
  PyObject *__pyx_v_capacity_ = 0;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("GENROUTE_ (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_Delta,&__pyx_n_s_gamma,&__pyx_n_s_h,&__pyx_n_s_capacity,&__pyx_n_s_N,&__pyx_n_s_quantities,&__pyx_n_s_distance_dict,0};
    PyObject* values[7] = {0,0,0,0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_gamma)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("GENROUTE_", 1, 7, 7, 1); __PYX_ERR(0, 134, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_h)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("GENROUTE_", 1, 7, 7, 2); __PYX_ERR(0, 134, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_capacity)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("GENROUTE_", 1, 7, 7, 3); __PYX_ERR(0, 134, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_N)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("GENROUTE_", 1, 7, 7, 4); __PYX_ERR(0, 134, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_quantities)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("GENROUTE_", 1, 7, 7, 5); __PYX_ERR(0, 134, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_distance_dict)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("GENROUTE_", 1, 7, 7, 6); __PYX_ERR(0, 134, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "GENROUTE_") < 0)) __PYX_ERR(0, 134, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 7) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("GENROUTE_", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 134, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cpp_lower_bounds.GENROUTE_", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_16cpp_lower_bounds_6GENROUTE_(__pyx_self, __pyx_v_Delta_, __pyx_v_gamma_, __pyx_v_h_, __pyx_v_capacity_, __pyx_v_N_, __pyx_v_quantities_, __pyx_v_distance_dict_);
...
static PyObject *__pyx_pf_16cpp_lower_bounds_6GENROUTE_(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_Delta_, PyObject *__pyx_v_gamma_, PyObject *__pyx_v_h_, PyObject *__pyx_v_capacity_, PyObject *__pyx_v_N_, PyObject *__pyx_v_quantities_, PyObject *__pyx_v_distance_dict_) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("GENROUTE_", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_16cpp_lower_bounds_GENROUTE_(__pyx_v_Delta_, __pyx_v_gamma_, __pyx_v_h_, __pyx_v_capacity_, __pyx_v_N_, __pyx_v_quantities_, __pyx_v_distance_dict_, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 134, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "list.to_py":92
 * 
 * @cname("__pyx_convert_list_to_py_struct__Path")
 * cdef object __pyx_convert_list_to_py_struct__Path(const cpp_list[X]& v):             # <<<<<<<<<<<<<<
 *     o = []
 *     cdef cpp_list[X].const_iterator iter = v.begin()
 */

static PyObject *__pyx_convert_list_to_py_struct__Path(std::list<struct Path>  const &__pyx_v_v) {
  PyObject *__pyx_v_o = NULL;
  std::list<struct Path> ::const_iterator __pyx_v_iter;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_t_2;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("__pyx_convert_list_to_py_struct__Path", 0);
 ...
 *     return o
 */
    __pyx_t_1 = __pyx_convert__to_py_struct__Path((*__pyx_v_iter)); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 96, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyList_Append(__pyx_v_o, __pyx_t_1); if (unlikely(__pyx_t_3 == ((int)-1))) __PYX_ERR(2, 96, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("list.to_py.__pyx_convert_list_to_py_struct__Path", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_o);
  __Pyx_XGIVEREF(__pyx_r);
...
/* "vector.to_py":60
 * 
 * @cname("__pyx_convert_vector_to_py_std_3a__3a_list_3c_struct__Path_3e___")
 * cdef object __pyx_convert_vector_to_py_std_3a__3a_list_3c_struct__Path_3e___(vector[X]& v):             # <<<<<<<<<<<<<<
 *     return [v[i] for i in range(v.size())]
 * 
 */

static PyObject *__pyx_convert_vector_to_py_std_3a__3a_list_3c_struct__Path_3e___(const std::vector<std::list<struct Path> >  &__pyx_v_v) {
  size_t __pyx_v_i;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  size_t __pyx_t_4;
  PyObject *__pyx_t_5 = NULL;
  __Pyx_RefNannySetupContext("__pyx_convert_vector_to_py_std_3a__3a_list_3c_struct__Path_3e___", 0);
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;
    __pyx_t_5 = __pyx_convert_list_to_py_struct__Path((__pyx_v_v[__pyx_v_i])); if (unlikely(!__pyx_t_5)) __PYX_ERR(2, 61, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    if (unlikely(__Pyx_ListComp_Append(__pyx_t_1, (PyObject*)__pyx_t_5))) __PYX_ERR(2, 61, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  }
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_XDECREF(__pyx_t_5);
  __Pyx_AddTraceback("vector.to_py.__pyx_convert_vector_to_py_std_3a__3a_list_3c_struct__Path_3e___", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyMethodDef __pyx_methods[] = {
  ...
  {"GENPATH_", (PyCFunction)__pyx_pw_16cpp_lower_bounds_5GENPATH_, METH_VARARGS|METH_KEYWORDS, 0},
  {"GENROUTE_", (PyCFunction)__pyx_pw_16cpp_lower_bounds_7GENROUTE_, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static PyObject* __pyx_convert__to_py_struct__QPaths(struct QPaths s) {
    ...
    static PyObject* __pyx_convert__to_py_struct__Path(struct Path s) {
      ...
      Py_DECREF(member);
      member = __pyx_convert_set_to_py_int(s.nodes); if (unlikely(!member)) goto bad;
      ...
      Py_DECREF(member);
      member = PyFloat_FromDouble(s.lower_bound); if (unlikely(!member)) goto bad;
      if (unlikely(PyDict_SetItem(res, __pyx_n_s_lower_bound, member) < 0)) goto bad;
      Py_DECREF(member);
