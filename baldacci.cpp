...
vector<list<Path>> GENPATH(
   ...
   while (true){
      ...
      /*
      Path suspicious;
      suspicious.path.push_back(5);
      suspicious.path.push_back(2);
      suspicious.path.push_back(1);
      if (p_star.path == suspicious.path && direction == "right"){
      ...
      */
      ...
      for (int i = 0; i < len_N; i++){
         ...
         if (p_star.nodes[i] == 0){
            ...
            /*
            if (new_path.path == suspicious.path && direction == "right"){
               cout<<"found it"<<endl;
...
vector<DualSolution> construct_lower_bound(
   ...
   cout<<"U from Christofides"<<endl;
   cout<<sol.u<<endl;
   cout<<"V from Christofides"<<endl;
   cout<<sol.v<<endl;
   ...
   for (int iter_2 = 0; iter_2<iterations_m2; iter_2++){
      ...
      cout<<"Us from Baldacci"<<endl;
      cout<<sol.u<<endl;
      cout<<"Vs from Baldacci"<<endl;
      cout<<sol.v<<endl;
      // Debugging
      if (iter_2 == 0){
         for (int i = 0; i < len_H; i++){
